  ...
  <div class="survey-form-sections">
    ...
    <section class="form-section card">
      ...
      <div class="form-section-body form-grid">
        ...
        <div class="field"><label>ห้อง / Room *</label><asp:DropDownList ID="ddlRoom" runat="server"/><small>แสดงเฉพาะห้องของชั้นที่เลือก</small></div>
      </div>
    </section>
    <section class="form-section card">
...
(function(){
  ...
  function updateRooms(){filter(room,floor.value);}
  function updateFloors(){filter(floor,building.value);updateRooms();}
